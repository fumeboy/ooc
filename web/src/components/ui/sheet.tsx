...
>(({ side = "left", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        "fixed z-50 gap-4 bg-[var(--card)] shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300",
        sheetVariants[side],
        className,
      )}
      {...props}
