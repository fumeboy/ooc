...
export default async function init(argv: string[]): Promise<void> {
  ...
  await write(join(targetPath, "package.json"), JSON.stringify({
    ...
    dependencies: {
      ...
      "@ooc/builtins/filesystem/search": DEFAULT_OOC_VERSION,
      "@ooc/builtins/knowledge_base/knowledge": DEFAULT_OOC_VERSION,
      "@ooc/builtins/terminal/terminal_process": DEFAULT_OOC_VERSION,
      "@ooc/builtins/interpreter/interpreter_process": DEFAULT_OOC_VERSION,
      "@ooc/builtins/agent/skill_index": DEFAULT_OOC_VERSION,
    },
    devDependencies: {
