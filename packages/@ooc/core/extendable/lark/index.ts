 ...
 *
 * 与 OOC core 的关系：
 * - feishu_chat / feishu_doc 仍然是一等 WindowType（声明在 src/executable/windows/_shared/types.ts），
 *   本目录只提供它们的实现 + 注册逻辑。
 * - 注册通过 src/executable/windows/_shared/registry.ts:registerWindowType 完成；
