 ...
 * `thinkable` ↔ `executable` 的类型反向耦合——一级子包（thinkable /
 * executable / observable / persistable / runtime）与 builtins/* 均**单向**
 * import 本包。
 *
 * 硬约束（违反即破坏分层）：
 * - 不 import 任何 `@ooc/core/{thinkable,executable,observable,persistable,runtime}`
