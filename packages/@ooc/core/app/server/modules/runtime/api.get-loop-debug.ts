...
export function getLoopDebugApi(service: RuntimeService, baseDir: string) {
  return new Elysia({ name: "ooc.runtime.api.get-loop-debug" }).get(
    "/runtime/flows/:sessionId/:objectId/threads/:threadId/debug/loops/:loopIndex",
