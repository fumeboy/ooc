 ...
 * 注册由 windows/index.ts 显式 `builtinRegistry.register("_builtin/feishu_app/feishu_chat", Class, { parentClass: null })`。
 *
 * feishu_chat 是窗类型（parentClass:null），通常由 feishu_app.open_chat 经
 * `ctx.runtime.instantiate("_builtin/feishu_app/feishu_chat", args)` 实例化。
 */
