/**
 * terminal_process 的 visible/diff 组件 —— bash exec history 的版本 diff（本 class 自有）。
 *
 * history 按 execId 配对：
...
export default function TerminalProcessWindowDiff({ previous, current }: WindowDiffProps) {
  ...
  return (
    <div data-testid="terminal-process-window-diff">
      <Section title="terminal_process fields" testId="terminal-process-fields">
      ...
      <Section title="history" testId="terminal-process-history">
