/**
 * interpreter_process 详情面板 —— 渲染 ts/js exec history（末条展开 script + output，其余折叠）。
 */
...
export default function InterpreterProcessWindowDetail({ window }: { window: OocObjectRef & { data: Data } }) {
