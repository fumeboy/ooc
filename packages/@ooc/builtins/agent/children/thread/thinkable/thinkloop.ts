import { decidePermission, type PendingToolCall } from "@ooc/core/executable/permissions";
import { dispatchToolCall, getAvailableTools } from "@ooc/core/executable/tools";
import { beginLlmLoop, finishLlmLoop, isPausing } from "@ooc/core/observable";
import type { ProcessEvent, ThreadContext } from "../types.js";
import type { LlmClient, LlmGenerateResult, LlmToolCall } from "@ooc/core/thinkable/llm/types";
import { LlmTimeoutError } from "@ooc/core/thinkable/llm/timeout.js";
import { buildInputItems } from "./context/index.js";
