...
我向 Agent 提供**系统级接口**：`create_object` 把一个全新对象的骨架（package.json + self.md + readable.md）落进当前 session 的 worktree，本 session 内即可用。后续治理（resolve PR-Issue / rollback）、类管理也归我。
