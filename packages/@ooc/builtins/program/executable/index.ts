...
// 共享 viewport helper 的再导出（program-history-viewport.test 从 barrel 取用）。
export {
...
// readable 维度（registerReadable：readable + window method set_history_window）在 ../readable.ts 自注册。
