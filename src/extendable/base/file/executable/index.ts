/**
 * base/file/executable — file 原型的 behavior 真源（OOC-4 L4.2c）。
 *
 * methods（set_range/set_viewport/reload/edit/close）+ renderXml + compressView 的**实现**住这里
...
import type { FileWindow } from "../../../../executable/windows/_shared/types.js";
import {
  DEFAULT_VIEWPORT,
  applyViewport,
