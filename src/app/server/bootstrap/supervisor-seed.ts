...
/** supervisor 的 readable.md 内容（对外公开介绍；其它 Object / user 在 relation 中读到）。 */
...
- **supervisor stone**：我自己的身份 + readable + 这套 seed knowledge
...
| 何时何处 | 哪一层 | 写什么 |
|---|---|---|
| 我创建该 Object | **stone** | \`stones/main/objects/pdf-extractor/{self.md, readable.md, knowledge/usage.md}\` |
