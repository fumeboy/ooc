 ...
 * @ref src/shared/types/object.ts — references — StoneData, Talkable, Thinkable, Relation 类型
...
import type { StoneData, Talkable, Thinkable, Relation } from "../shared/types/index.js";
