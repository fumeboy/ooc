/**
 * knowledge_window —— 薄注册壳（OOC-4 L4.2c / L6c-1）。
 *
 ...
 * 薄壳不再 registerWindowType onClose。本壳只剩 markRenderXmlViaPrototype——声明 renderXml
 * 由 base 原型链提供，让同步的 assertAllRenderHooksRegistered 不误判缺失（plan D4）。
 */
