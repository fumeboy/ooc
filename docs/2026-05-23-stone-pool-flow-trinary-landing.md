...
> **2026-05-24 修订**：knowledge 进一步拆为 **seed（stone, git review）/ sediment（pool, 写就生效）** 二分——
> 详见文末"2026-05-24 修订：knowledge seed/sediment 二分"段。原文中"knowledge 全部迁 pool"的表述以修订段为准。
