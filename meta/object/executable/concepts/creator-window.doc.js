...
initContextWindows 直接返回。
  ...
  hasRealCreatorRule_v20260517_1: {
    ...
    optsCreatorThreadId_v20260517_1: {
      title: "opts.creatorThreadId — fork / talk-delivery 调用方显式给出。",
      content: `#### opts.creatorThreadId — fork / talk-delivery 调用方显式给出。`,
    },

    threadCreatorThreadId_v20260517_1: {
      title: "thread.creatorThreadId — 磁盘恢复时 thread.json 里已写过。",
      content: `#### thread.creatorThreadId — 磁盘恢复时 thread.json 里已写过。`,
    },

    threadCreatorObjectId_v20260517_1: {
      title: "thread.creatorObjectId — 跨 object talk-delivery 总会设这条。",
      content: `#### thread.creatorObjectId — 跨 object talk-delivery 总会设这条。`,
    },
  },
  ...
  idempotency_v20260517_1: {
    ...
    stableIdDerivation_v20260517_1: {
...
让磁盘恢复 / 重复 init 调用都能命中同一 id，避免出现两个 creator window。
    ...
    skipIfAlreadyPresent_v20260517_1: {
