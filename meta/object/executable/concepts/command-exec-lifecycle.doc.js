...
`,
      ...
      commandErrorPrefix_v20260517_1: {
        index: `##### [command-error] — manager 在 catch 块包装异常时的固定前缀。`,
      },

      legacyErrorWord_v20260517_1: {
        index: `##### [error] — 早期实现手写前缀；遗留代码使用，新 command 不应再写。`,
      },

      perCommandPrefix_v20260517_1: {
        index: `##### [<command>] / [<window>.<command>] — 各 command 自定义错误前缀（如 [file_window.edit] / [talk_window.say]），便于 LLM 识别错误来源。`,
      },
    },
