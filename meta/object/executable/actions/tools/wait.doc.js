...
不用为每种类型写独立分支。
    ...
    r4SelfBuiltUnsaid_v20260517_1: {
      title: "R4 — 自建 talk_window 但未 say 过",
      content: `
...
线程主状态切到 waiting；thinkloop 不再驱动它，直到 scheduler 翻醒。
    ...
    inboxSnapshot_v20260517_1: {
      title: "thread.inboxSnapshotAtWait = thread.inbox.length",
      content: `
