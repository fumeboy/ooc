...
- 外在自我 — 他者可见
    ...
    - 不暴露内在思考、风格偏好
    - 当其他对象要和自己交互时，对方的 context 中的 knowledge/relation 信息窗口中会出现自己的 readme.md 的信息
...
2. 自我更新路径独立
    - 改写 self.md → 影响自己的思考方式
    - 改写 readme.md → 影响其他对象如何看待自己
    - 两者通常独立演化
...
必须通过 super 分身的 SuperFlow 通道（详见 reflectable）。
`,
