...
`,
    ...
    tieBreakStable_v20260517_1: {
      index: `
### 不变量：lastExecutedAt 平手时按 thread id 字典序
...
`,
    ...
    pauseCheckerInjection_v20260517_1: {
      index: `
### 不变量：scheduler 通过 setPauseChecker 注入 hook
...
`,
    ...
    layeringSeparation_v20260517_1: {
      index: `
### 不变量：scheduler 不知道 HTTP / 持久化 / pause 概念
...
`,
    ...
    independentScheduler_v20260517_1: {
      index: `
### 不变量：SuperScheduler 与普通 scheduler 隔离
