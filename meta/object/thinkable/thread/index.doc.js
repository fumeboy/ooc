...
`,
    ...
    nodeIndependence_v20260517_1: {
      index: `
### 不变量：节点独立持有 ThreadContext
...
`,
    ...
    crossThreadFlowConstraint_v20260517_1: {
      index: `
### 不变量：跨线程信息流必须显式经过 message / transcript
...
`,
    ...
    runningOnlySchedulable_v20260517_1: {
      index: `
### 不变量：仅 running 被调度
...
`,
    ...
    failedSameAsDoneWakeup_v20260517_1: {
      index: `
### 不变量：failed 的唤醒行为同 done
...
`,
    ...
    rationaleScopeIsolation_v20260517_1: {
      index: `
### 理由 2：作用域隔离
...
`,
    ...
    rationaleParallelism_v20260517_1: {
      index: `
### 理由 3：并行
...
`,
    ...
    creatorWindowImmutable_v20260517_1: {
      index: `
### 不变量：creator do_window 不可被 LLM close
...
`,
    ...
    markerWithLastExecutedAt_v20260517_1: {
      index: `
### child-end marker 含 lastExecutedAt
...
`,
    ...
    waitTrueSynchronization_v20260517_1: {
      index: `
### wait=true 父线程同步入眠
